...
/**
 * geoip
 * determine geographical information from ip address with lookup tables
 *
 * @author      MaxMind, LLC
 * @copyright   Creative Commons Attribution-ShareAlike 3.0 Unported 
 * @license     http://creativecommons.org/licenses/by-sa/3.0/
 * @package     qoob
 * @subpackage  utils\location
 *
 * @todo combine anonymous functions and constants into the main class.
 */
namespace qoob\utils\location;
...
"Aland Islands","Guernsey","Isle of Man","Jersey","Saint Barthelemy","Saint Martin"
  ...
  "EU", "NA", "NA"
    ...
    public function getCountry($ip) {
      if(strpos($ip, ":") > 0) {
        $gi = geoip_open(dirname(__FILE__).DIRECTORY_SEPARATOR."GeoIPv6.dat", GEOIP_STANDARD);
